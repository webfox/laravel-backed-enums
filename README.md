...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-backed-enums.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-backed-enums)
...
```bash
php artisan vendor:publish --tag="laravel-backed-enums-migrations"
php artisan migrate
```
...
```bash
php artisan vendor:publish --tag="laravel-backed-enums-config"
```
...
```bash
php artisan vendor:publish --tag="laravel-backed-enums-views"
```

## Usage

```php
$laravelBackedEnums = new Webfox\LaravelBackedEnums();
echo $laravelBackedEnums->echoPhrase('Hello, Webfox!');
```
...
- [Webfox Developments Ltd](https://github.com/webfox)
